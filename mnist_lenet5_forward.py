...
#	reshaped = tf.reshape(pool2,[pool_shape[0],nodes])
	reshaped = slim.flatten(pool2)
	conv_shape = pool2.get_shape().as_list()
	nodes = conv_shape[1] * conv_shape[2] * conv_shape[3]
	...
	fc3_w = get_weight([FC2_SIZE,OUTPUT_NODE],regularizer)
